...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Login || Electronic Mania</title>
  ...
  <body style="background-image:url(images/login.jpg);">
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <center><img src="images/icon.png" style="height: 100px; width:100px; margin-top: 1.5in"></center>
        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="manishce1999@gmail.com" name="username">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Login" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
               <a class="btn" href="register.php"style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">Signup</a>
            </div>
          </div>
        </div>
      </div>
