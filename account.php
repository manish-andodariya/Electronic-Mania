...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Account || Electronic Mania</title>
    <link rel="stylesheet" href="css/foundation.css" />
    <script src="js/vendor/modernizr.js"></script>
  </head>
  <body style="background-image: url(images/acc.jpg);">
...
<center>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        <p><?php echo '<h3 style="text-align:center; text-decoration:underline;">Hi ' .$_SESSION['fname'] .'</h3>'; ?></p>

        <p><h4 style="color:white; text-align: center;">Account Details</h4></p>

        <p style="text-align: center;">Below are your details in the database. If you wish to change anything, then just enter new data in text box and click on update.</p>
      </div>
    </div>
        ...
        <div class="small-12">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Update" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em;padding: 10px;margin-left: -0.9in;">
