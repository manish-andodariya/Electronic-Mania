        ...
        <?php
          ...
          if($result) {
            while($obj = $result->fetch_object()) {
              ...
              echo "</div>";
              if ($obj->delivery==0) {
                echo "<a href=delete.php?id=".$obj->id."&p=".$obj->product_code." style='background:#0078A0; border-style:solid; border-width:2px; border-color:darkorange; color:white; font-size: 1em; padding: 5px; margin-left:10px;'>Cancel Order</a>";
              }
              else
              {
                
                echo '<p style="color:wheat;">Your Order is Delivered</p>';
