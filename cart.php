...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || Electronic Mania</title>
    <link rel="stylesheet" href="css/foundation.css" />
    <script src="js/vendor/modernizr.js"></script>
  </head>
  <body style="background-image:url(images/cart.jpg);">
      ...
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['username'])) {
            ...
            echo '<a href="http://www.paytm.com" target="_blank"><button style="float:right;">Paytm</button></a>';
            echo '<a href="http://www.onlinesbi.com" target="_blank"><button style="float:right;">NetBanking</button></a>';
          }
          ...
          echo '</table>';
               ...
               echo "<br><h5 style='color:wheat;'>you have no items in your shopping cart.</h5>";
        }
